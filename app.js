function reverseString(str) {
  ...
  function getNextPalindromeDate(date) {
    ...
    while (1) {
      ...
      var resultList = checkPalindromeForAllFormat(dateStr);
  ...
  var ctaButton = document.querySelector("#show-btn");
  ...
  function clickHandler(e) {
    ...
    if (bdayString !== "") {
      ...
      if (!isPalindrome) {
        ...
        resultDiv.innerText = "Lucky huh. Your birthday is a palindrom.";
      }
    }
  }
